...
public class ContactManagerTest {
    ...
    private Contact[] contacts = {
            new Contact("John", "Doe", "johndoe@example.com", "0423423423", "Sunny#85Cloud"),
            new Contact("Jane", "Doe", "janedoe@example.com", "0423423424", "Jazz!47Keys\n"),
            new Contact("Jay", "Doe", "jaydoe@example.com", "0423423425", "Magic!23Moon"),
            new Contact("John", "Smith", "johnsmith@example.com", "0423423426", "Ocean_88Blue"),
            new Contact("Jane", "Smith", "janesmith@example.com", "0423423427", "Tiger$32Run"),
            new Contact("Alice", "Graystone", "aliceg@gmail.com", "0423423428", "Pixel_99Tree"),
            new Contact("Shane", "Graystone", "shaneg@gmail.com", "0423423429", "HappyDog#202")
    };
    ...
    public void testSearchNullQuery() {
        ...
        assertEquals(7, contacts.size());  // Expecting 7, not 6
    }
